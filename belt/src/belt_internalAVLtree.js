...
function findFirstBy(n, p) {
  return findFirstByU(n, (function (a, b) {
                return p(a, b);
              }));
}
...
function mapWithKey(n, f) {
  return mapWithKeyU(n, (function (a, b) {
                return f(a, b);
              }));
}
...
function reduce(m, accu, f) {
  return reduceU(m, accu, (function (a, b, c) {
                return f(a, b, c);
              }));
}
...
function keepShared(n, p) {
  return keepSharedU(n, (function (a, b) {
                return p(a, b);
              }));
}
...
function keepMap(n, p) {
  return keepMapU(n, (function (a, b) {
                return p(a, b);
              }));
}
...
function partitionShared(n, p) {
  return partitionSharedU(n, (function (a, b) {
                return p(a, b);
              }));
}
...
function cmp(s1, s2, kcmp, vcmp) {
  return cmpU(s1, s2, kcmp, (function (a, b) {
                return vcmp(a, b);
              }));
}
...
function eq(s1, s2, kcmp, veq) {
  return eqU(s1, s2, kcmp, (function (a, b) {
                return veq(a, b);
              }));
}
